...
export default function Footer() {
  return (
    <footer className="py-12 px-4 sm:px-6 md:px-12 bg-zinc-950 text-zinc-400 border-t border-zinc-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left text-xs sm:text-sm text-zinc-600 pt-8 border-t border-zinc-900">
          ...
          <p>Webdesign by <a href="https://vamela.info" target="_blank" rel="noopener noreferrer" className="font-bold text-zinc-400 tracking-wider hover:text-white transition-colors">VAMELA</a></p>
        </div>
      </div>
    </footer>
  );
